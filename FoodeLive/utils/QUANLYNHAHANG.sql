...
ALTER table nhanvien
add TENNGUOIDUNG varchar(20) UNIQUE
...
ALTER TABLE NHANVIEN
ADD MATKHAU VARCHAR(30)
ALTER TABLE nhanvien
alter column tennguoidung add UNIQUE
...
INSERT INTO BANAN(MABANAN,LOAI) VALUES ('B06',N'8 chỗ')
INSERT INTO BANAN(MABANAN,LOAI) VALUES ('B07',N'8 chỗ')
...
select top 1 * from banan order by mabanan DESC

DELETE from nhanvien where MANV='nv08'
select * from nhanvien where tennguoidung='admin' and matkhau='admin'

insert into nhanvien (manv, TENNGUOIDUNG, MATKHAU) VALUES ('NV09','tuankietcoder','1')
alter table nhanvien add UNIQUE (tennguoidung)